...
export function coordonee(x=Math.floor(Math.random()*50), y=Math.floor(Math.random()*50)){
    return [x,y];
};
...
export function orientation(cardinaux=['N','S','E','O']){
...
export function majOrientationRover(rover,commande){
...
export function majPositionRover( rover, command){
    const map2maps = {
...
export function majOrientationPosition(rover , commandeList) {
...
export function obstacle(x=Math.floor(Math.random()*50), y=Math.floor(Math.random()*50)){
return [x,y]
}
